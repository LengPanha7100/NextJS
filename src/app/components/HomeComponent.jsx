          ...
          {cardtypes.map((item, index) => (
            <div key={index} className='relative'>
              ...
              <div className="relative group">
                ...
                <div className="absolute inset-0 bg-[#00000063] rounded-4xl 00 bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out">
